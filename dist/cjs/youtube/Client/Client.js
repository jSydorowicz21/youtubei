...
class Client {
    constructor(options = {}) {
        this.options = Object.assign(Object.assign({ initialCookie: "", proxy: "", fetchOptions: {} }, options), { youtubeClientOptions: Object.assign({ hl: "en", gl: "US" }, options.youtubeClientOptions) });
